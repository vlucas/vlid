...
Lightweight validation library with NO dependencies targeting web browsers and Node.js. A nice Joi alternative with a similar API.

A full featured validation library at just **7kb** minified (before gzipping).
